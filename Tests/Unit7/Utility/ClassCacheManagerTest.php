...
#';
     ...
     * @test
     */
    public function reBuildWithStorageAndContructorArgument()
    {
        $this->prepareFixtureClassMap();
        $this->activateFixtureExtensions();

        $className = \Fixture\BaseExtension\Domain\Model\BlobWithStorageAndContructorArgument::class;
        $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['base_extension']['extender'][$className] = [
            'extending_extension' => 'Model/BlobWithStorageExtend',
        ];
        ...
        $fixtureFolder = __DIR__ . '/../../Unit/Fixtures/Extensions/';
        $basePath = realpath($fixtureFolder . 'base_extension/Classes/Domain/Model/BlobWithStorageAndContructorArgument.php');
        $extendPath = realpath(
            $fixtureFolder . 'extending_extension/Classes/Extending/Model/BlobWithStorageExtend.php'
        );
...
class BlobWithStorageAndContructorArgument extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    /**
     * @var string
     */
